...
. Use the values displayed in the *Outputs* tab for the stack, as shown in Figure 2, to view the resources that were created.
...
=== Test the deployment
ifndef::production_build[_**This portion of the deployment guide is located at `docs/{specificdir}/test_deployment.adoc`**_]
