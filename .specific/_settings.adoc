...
// Uncomment the following attribute if you would like to provide custom text about which regions are supported in the partner-editable/regions.adoc file.
