...
[cols=3*]
|===
^|{launch_new_vpc}[Deploy into a new VPC and new EKS cluster^]
^|{launch_existing_vpc}[Deploy into a new EKS cluster in an existing VPC^]
^|{launch_existing_cluster}[Deploy into an existing EKS cluster^]
