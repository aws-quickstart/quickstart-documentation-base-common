...
_**This portion of the deployment guide is located in `docs/{specificdir}/__settings_.adoc`**_
[.preview_mode]
|===
a|
...
TIP: Visit the https://github.com/aws-quickstart/{quickstart-project-name}[GitHub repository^] for source files and to post feedback,
