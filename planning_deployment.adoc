...
include::../{includedir}/regions.adoc[]
endif::custom_supported_regions[]

ifdef::custom_supported_regions[]
// Set the custom_supported_regions variable in _settings.adoc to include the content from regions.adoc in the "Supported AWS Regions" section.
