...
ifndef::in_repo[_**This portion of the deployment guide is located at `docs/{specificdir}/specialized_knowledge.adoc`**_]
ifndef::in_repo[====]
...
ifndef::in_repo[_**This portion of the deployment guide is located at `docs/{specificdir}/regions.adoc`**_]
ifndef::in_repo[====]
...
==== EC2 Key Pairs
ifndef::in_repo[====]
ifndef::in_repo[_This section is conditional on EC2 instances being used in the Cloudformation Templates_]
ifndef::in_repo[====]
